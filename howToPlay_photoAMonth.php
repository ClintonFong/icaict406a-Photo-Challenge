<?php
    ...
    $title = "Photo Challenge - How to play: Photo A Month";
    if( $_SERVER["HTTP_X_PJAX"] ): 
	    echo "<title>{$title}</title>";

        include "include/howToPlay_photoAMonth-pjax.php"; 
...
?>
        ...
        <head>
            ...
            <title>Photo Challenge - How to play: Photo A Month</title>
        ...
        <body>
            ...
            <section id='pjaxCntMainContent'>
                <?php include "include/howToPlay_photoAMonth-pjax.php";	?>
            </section>

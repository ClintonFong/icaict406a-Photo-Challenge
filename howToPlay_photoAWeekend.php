<?php
    ...
    $title = "Photo Challenge - How to play: Photo A Weekend";
    if( $_SERVER["HTTP_X_PJAX"] ): 
	    echo "<title>{$title}</title>";

        include "include/howToPlay_photoAWeekend-pjax.php"; 
...
?>
        ...
        <head>
            ...
            <title>Photo Challenge - How to play: Photo A Weekend</title>
        ...
        <body>
            ...
            <section id='pjaxCntMainContent'>
                <?php include "include/howToPlay_photoAWeekend-pjax.php";	?>
            </section>
